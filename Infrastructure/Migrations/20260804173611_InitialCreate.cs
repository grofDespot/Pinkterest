        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxUploadSizeBytes = table.Column<long>(type: "bigint", nullable: false),
                    DailyUploadLimit = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PendingPackageId = table.Column<Guid>(type: "uuid", nullable: true),
                    PendingPackageEffectiveDate = table.Column<DateOnly>(type: "date", nullable: true),
                    LastPackageChangeUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Packages_PendingPackageId",
                        column: x => x.PendingPackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyUsages", x => new { x.UserId, x.Date });
                    table.ForeignKey(
                        name: "FK_DailyUsages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FilterPresets_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_PendingPackageId",
                table: "AspNetUsers",
                column: "PendingPackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyUsages_Date",
                table: "DailyUsages",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_FilterPresets_OwnerId_Name",
                table: "FilterPresets",
